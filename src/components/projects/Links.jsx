                    ...
                    links.map((link) => (
                        ...
                        : (
                            <a
                                ...
                                target="__blank"
                                aria-label="Google Play"
                                className="flex items-center justify-center h-full bg-black border-2 text-gray-400 hover:text-primary-dark dark:hover:text-primary-light p-2 rounded-2xl shadow-sm duration-500"
                                style={{height: "6.7em", width: "22em"}}
                            >
                                <p className="font-general-medium text-2xl sm:text-3xl font-bold text-primary-dark dark:text-primary-light">
                                    Visit the website
                                </p>
                            </a>
                        )
